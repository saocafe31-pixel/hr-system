...
| ชื่อ | ใช้ทำอะไร |
|------|-----------|
| `app_settings` | ค่าระบบ — คีย์ `announcement_slides` เก็บ `{ urls, slide_height_px }` สำหรับสไลด์หน้าเข้า-ออก; คีย์ `attendance_kpi_settings` เก็บเกณฑ์ KPI ลา/เข้าสาย |
...
- [x] งาน + checklist + แนบไฟล์ + แจ้งเตือนงาน
- [x] แชท + mention notifications
- [x] คอมมูนิตี้ (โน้ต + ฟีด)
- [x] โปรไฟล์ (รูป crop, notification prefs, push token path, KPI ลา/ขอเข้าสายรายไตรมาสและภาพรวมปี)
- [x] แอดมิน: พนักงาน legacy, สาขา, เชื่อม HR, โควตา, ประกาศ, ตั้งค่า, สิทธิ์ผู้จัดการ & ลูกทีม (ทีม manager แบบจำกัดขอบเขต)
- [x] โปรไฟล์: เมนูเบิกเงินเดือน (สูตร 70% ของ 50% ฐานเงินเดือนในช่วงวันที่ 10-14) + เบิกค่าใช้จ่ายหลายรายการพร้อมแนบหลักฐาน
- [x] แอดมิน: เมนูรับคำขอเบิกเงินเดือน/ค่าใช้จ่าย พร้อมแสดงข้อมูลบัญชีและหลักฐานแยกรายการ
