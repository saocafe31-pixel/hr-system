...
- [x] ตารางงาน (กะ + มอบหมาย + สาขาที่เข้าได้) + ปฏิทินรายวันในหน้า schedule + ปฏิทินส่วนตัวในหน้า attendance + popup `Schedule · Notes · Live Work` ในหน้า chat/team แสดงสถานะลาอนุมัติแทนตารางเข้างานเมื่อวันนั้นมีลา
